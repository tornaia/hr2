...
public class EvesSzabadsagAdatCreateDTO {
	...
	public void setAlapszabadsag(int alapszabadsag) {
	...
	public void setGyermekekUtan(int gyermekekUtan) {
	...
	public void setFiatalkoru(int fiatalkoru) {
	...
	public void setVakSzemely(int vakSzemely) {
	...
	public void setEgyebMunkakor(int egyebMunkakor) {
	...
	public void setKtKaPotszabadsag(int ktKaPotszabadsag) {
	...
	public void setKtKaVezetoi(int ktKaVezetoi) {
	...
	public void setEgyebCsokkento(int egyebCsokkento) {
	...
	public void setTanulmanyi(int tanulmanyi) {
	...
	public void setMultEviSzabadsag(int multEviSzabadsag) {
	...
	public void setBszJarandosagAdottEvi(int bszJarandosagAdottEvi) {
